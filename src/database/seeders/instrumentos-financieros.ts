...
import { InstrumentoFinanciero, Riesgo, TipoInstrumento } from "src/instrumentos-financieros/entities/instrumento-financiero.entity";
...
export async function seedInstrumentosFinancieros(dataSource: DataSource): Promise<void> {
